...
import gogsky.lib.LibResources;
...
public class GogSkyRenderer extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		int glSkyList2 = ReflectionHelper.getPrivateValue(RenderGlobal.class, mc.renderGlobal, "glSkyList2", "field_72781_x"); // Horizon line. We don't have it here
		...
		float t = (ClientTickHandler.ticksInGame + ClientTickHandler.partialTicks + 2000) * 0.005F;
		GL11.glPushMatrix();
		GL11.glDisable(GL11.GL_TEXTURE_2D);
