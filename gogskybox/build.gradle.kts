...
minecraft {
  ...
  // tagReplacementFiles.add("GogSkybox.java")
...
// Generates a class named gogsky.gogskybox.Tags with the mod version in it, you can find it at
