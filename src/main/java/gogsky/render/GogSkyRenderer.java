...
public class GogSkyRenderer extends IRenderHandler {

    private static final ResourceLocation textureSkybox = new ResourceLocation("gogskybox:textures/misc/skybox.png");
    private static final ResourceLocation textureRainbow = new ResourceLocation("gogskybox:textures/misc/rainbow.png");
    ...
    private static final ResourceLocation[] planetTextures = new ResourceLocation[] {
        new ResourceLocation("gogskybox:textures/misc/planet0.png"),
        new ResourceLocation("gogskybox:textures/misc/planet1.png"),
        new ResourceLocation("gogskybox:textures/misc/planet2.png"),
        new ResourceLocation("gogskybox:textures/misc/planet3.png"),
        new ResourceLocation("gogskybox:textures/misc/planet4.png"),
        new ResourceLocation("gogskybox:textures/misc/planet5.png")
    };
    ...
    private static final String[] STAR_GL_CALL_LIST = new String[] { "starGLCallList", "field_72772_v", "F" };

    @Override
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        // 反射获取RenderGlobal的私有字段
